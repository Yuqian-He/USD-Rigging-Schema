...
class  SOP_testSkeletonParms  : public SOP_NodeParms
{
public:
    static int version() { return 1; }

    SOP_testSkeletonParms()
    {
        myUsdfile = "0"_sh;

    }

    explicit SOP_testSkeletonParms(const SOP_testSkeletonParms &) = default;

    ~SOP_testSkeletonParms() override {}

    bool operator==(const SOP_testSkeletonParms &src) const
    {
    ...
    {
        *this = *((const SOP_testSkeletonParms *)src);
    }
